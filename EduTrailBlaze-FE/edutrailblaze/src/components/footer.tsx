              ...
              <div className="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
                <div className="lg:col-span-4 md:col-span-12">
                  ...
                  <p className="mt-6 text-gray-300 text-justify">
                    ...
                    EduTrailBlaze. Whether you're a student eager to learn or a
                    teacher seeking to inspire, our platform offers a diverse
                    range of courses, tools, and resources to support your
                    educational journey. Join us and ignite your passion for
                    learning.
                  </p>
                ...
                <div className="lg:col-span-2 md:col-span-4 text-center lg:text-justify">
                  <h5 className="tracking-[1px] text-yellow-300 font-semibold">
                    EduTrailBlaze
                  </h5>
