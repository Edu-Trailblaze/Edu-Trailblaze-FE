    ...
    <>
      ...
      <div className='container mb-10'>
        <div className='w-[900px]'>
          ...
          >
            Stemming from the principles of storytelling and design established
            in CalArts’ renowned Animation programs, this Specialization lays a
            primary foundation for experimentation and exploration of video game
            design, story, character development, and winning gameplay before
            programming begins. <br /> These four courses emphasize the
            self-reliance and personal expression of the gaming artist, and
            encourage you to take conceptual risks and develop new modes of
            expression and form through gaming.
            <br /> Applied Learning Project In the final Capstone Project,
            you’ll put your creative skills to work by generating an engaging
            game design document for a personal game project, outlining the
            conceptual, narrative and aesthetic elements of your game. This
            four-part capstone project guides you to distill and improve the
            foundational aspects of your game so that you may express your ideas
        ...
        <div className='grid grid-cols-12'>
          ...
          <div className='col-span-8 border-2 rounded-lg px-10 py-4 mr-12'>
            {courses.map((course, index) => (
              <div
                key={index}
                className='border-b last:border-0 py-4 flex justify-between'
              >
                <div>
                  ...
                  <div className='flex text-sm text-gray-500 space-x-4'>
                    ...
                    <span>•</span>
                    <span className='text-blue-500 tracking-wide font-semibold'>
                      ★ {course.rating}
                    </span>
          ...
          {/* instructors */}
          <div className='col-span-4 border-2 rounded-lg px-10 py-4'>
            <div className='py-4'>
                  ...
                  <div className='ml-5'>
                    ...
                    <div>
                      ...
                      <span className='text-xs text-gray-500'>
                        {value.learner} learners
                      </span>
                    </div>
                  </div>
                </div>
              ))}
              <p className='text-sm text-blue-700 border-b pb-5'>
