    ...
    <div className="px-[100px] py-[70px]">
      ...
      <div className="flex justify-evenly pt-28">
        <div className="text-center">
          ...
          <p className="w-[300px]">Students practice at their own pace, first filling in gaps in their understanding and then accelerating their learning.</p>
        </div>
        <div className="text-center">
          ...
          <p className="w-[300px]">Created by experts, EduTrailBlaze’s library of trusted practice and lessons covers math, science, and more. Always free for learners and teachers.</p>
        </div>
        <div className="text-center">
          ...
          <p className="w-[300px]">
          With EduTrailBlaze, teachers can identify gaps in their students’ understanding, tailor instruction, and meet the needs of every student.</p>
        </div>
      </div>
    </div>
  );
