      ...
      <div className="bg-gray-100 flex rounded-2xl shadow-xl max-w-4xl p-5">
        ...
        {isLogin ? (
          <div className="sm:w-1/2 px-12 py-10">
            ...
            <button className="bg-white border py-2 w-full rounded-xl mt-5 flex justify-center items-center text-center text-sm">
            ...
            <form action="" className="flex flex-col gap-4 mt-4">
              ...
              <button className="bg-blue-500 rounded-xl text-white py-2">
                Log in
              </button>
            </form>
          ...
          <div className="sm:w-1/2 px-12 py-10">
            ...
            <form action="" className="flex flex-col gap-4 mt-4">
              ...
              <button className="bg-blue-500 rounded-xl text-white py-2 my-2">
                Register
              </button>
            </form>
            <div className="border-t-[1px] mt-4 border-[#9ca3af]"></div>
