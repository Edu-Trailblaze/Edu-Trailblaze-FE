  ...
  return (
    <div className=' flex container bg-[#F4F4F4] py-[70px] rounded-lg'>
      <div className='w-[220px]'>
        ...
        <p className='pt-5'>
          These are reviews from students throughout the process of participating in courses at WebsiteName
        </p>
        <button
        ...
        <div className='max-w-72 mx-auto p-6 bg-white shadow-lg rounded-lg border-2 border-[#80808069]'>
          <div className='text-gray-900 font-medium mb-4'>
            ...
            <p className='text-black font-semibold'>
              "This C# course is really good and completed. It help me to solve many problem that I am facing now in
              coding C#."
            </p>
          </div>
          ...
          <div className='mt-6'>
            <a href='#' className='flex items-center justify-end text-blue-500 font-semibold text-sm hover:underline'>
              View the C# Course
              <svg
