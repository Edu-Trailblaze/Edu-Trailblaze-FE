          ...
          {[1, 2].map((_, index) => (
            <div key={index} className='flex items-start gap-4'>
              ...
              <div className='flex-1'>
                ...
                <a href='#' className='text-blue-600 text-sm hover:underline block mb-1'>
                  View certificate
                </a>
          ...
          {[
            ...
            <div key={index} className='flex items-start gap-4'>
              ...
              <div className='flex-1'>
                ...
                <div className='flex flex-wrap gap-2 mb-2'>
                  {['Project Management', 'Strategy and Operations', 'Leadership and Management']
                    .slice(0, index + 2)
                    .map((skill) => (
                      <span key={skill} className='bg-gray-100 px-3 py-1 rounded-full text-sm'>
                        {skill}
                ...
                <p className='text-sm text-gray-600'>Completed {index === 2 ? 'January' : 'February'} 2025</p>
              </div>
            </div>
          ))}
        </div>
