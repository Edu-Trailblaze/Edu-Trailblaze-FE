...
import { useChangeRoleMutation } from '@/redux/services/auth.service'
import { jwtDecode } from 'jwt-decode'
import { toast } from 'react-toastify'
import { useRouter } from 'next/navigation'
import { useDispatch } from 'react-redux'
import { changeUserRole } from '@/redux/slice/auth.slice'

export default function BecomeInstructor() {
  const router = useRouter()
  const [userId, setUserId] = useState('')
  const [userRole, setUserRole] = useState('')
  const [userChangeRole, setUserChangeRole] = useState('')
  ...
  console.log('userChangeRole', userChangeRole)
          ...
          <div className='flex flex-col lg:flex-row items-center justify-between'>
            <div className='lg:w-1/2 mb-10 lg:mb-0 lg:pr-12'>
              ...
              <p className='text-lg text-gray-600 mb-8'>
                Become a lecturer, not only share knowledge but also inspire, direct and change the lives of others,
                while discovering and developing yourself. <br />
                <br /> Get started now and make a positive impact with us!
              </p>
              <button
                onClick={handleChangeRole}
                className='bg-gradient-to-r from-blue-500 to-blue-700 text-white font-medium py-3 px-8 rounded-lg shadow-lg hover:opacity-90 transition duration-300'
              >
                Get Started Now
              </button>
            </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
            ...
            <div className='bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition duration-300'>
              ...
              <p className='text-gray-600 text-center'>
                Publish courses the way you want, in the field you're passionate about, with complete control over your
                content.
              </p>
            </div>
            ...
            <div className='bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition duration-300'>
              ...
              <p className='text-gray-600 text-center'>
                Share knowledge and help students discover their potential, develop new skills, and advance in their
                careers.
              </p>
            </div>
            ...
            <div className='bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition duration-300'>
              ...
              <p className='text-gray-600 text-center'>
                Develop your professional network, build your reputation, and earn income from each course enrollment.
              </p>
            </div>
          </div>
        </div>
            ...
            <div>
              <div className='mb-12'>
                ...
                <p className='text-gray-600 pl-16'>
                  Start with your passion and expertise. Choose an engaging topic with support from our market analysis
                  tools.
                </p>
              </div>
              ...
              <div className='mb-12'>
                ...
                <p className='text-gray-600 pl-16'>
                  How you teach — what you bring to it — is your differentiator. We provide guidelines to create quality
                  video lectures.
                </p>
              </div>
              ...
              <div>
                ...
                <p className='text-gray-600 pl-16'>
                  We provide many resources to help you create your first course. Our platform helps you organize and
            ...
            <div className='lg:w-2/3 p-8 lg:p-12'>
              <div className='flex items-start mb-6'>
                ...
                <p className='text-xl lg:text-2xl font-medium text-gray-700'>
                  "I'm proud to know that my work is helping people around the world develop their careers and build
                  amazing things. While being a full-time instructor is challenging, it allows me to work when, where,
                  and how I want."
                </p>
              </div>
              <div className='pl-14'>
