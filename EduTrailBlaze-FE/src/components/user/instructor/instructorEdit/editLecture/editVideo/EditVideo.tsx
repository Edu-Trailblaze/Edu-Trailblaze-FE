        ...
        <div className='flex justify-end gap-3 mt-8'>
          {videoData && videoData[0]?.videoUrl ? (
            ...
            <button
              ...
              disabled={isSaving}
              type='button'
              className={`inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg shadow-sm text-white bg-indigo-600 ${isSaving ? 'opacity-75 cursor-not-allowed' : 'hover:bg-indigo-700'}  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition duration-150`}
            >
              {isSaving ? (
                <>
                  <svg
