      ...
      <div className='w-full max-w-[280px] sm:max-w-md md:max-w-lg bg-white rounded-lg shadow-lg p-4 sm:p-6 md:p-8'>
        ...
        <div className='mt-4 sm:mt-6 bg-red-50 border border-red-100 rounded-md p-3 sm:p-4'>
          <div className='flex flex-col space-y-1'>
            <span className='text-sm sm:text-base font-medium text-red-800'>Error Details:</span>
            <span className='text-sm text-red-600'>Insufficient funds in the account</span>
            <span className='text-xs text-gray-500'>Error Code: ERR_PAYMENT_{paymentId}</span>
          </div>
        </div>

        {/* Common Issues */}
        <div className='mt-4 sm:mt-6'>
          <h2 className='text-sm sm:text-base font-semibold text-gray-700 mb-2'>Common Reasons for Failure:</h2>
